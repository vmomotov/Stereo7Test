...
set(SPINE_CPP_HEADERS)
set(SPINE_CPP_SOURCES)
...
set(SPINE_COCOS2DX_HEADERS)
set(SPINE_COCOS2DX_SOURCES)
file(GLOB_RECURSE SPINE_COCOS2DX_HEADERS "${SPINE_RUNTIMES_PATH}/spine-cocos2dx/src/**/*.h")
file(GLOB_RECURSE SPINE_COCOS2DX_SOURCES "${SPINE_RUNTIMES_PATH}/spine-cocos2dx/src/**/*.cpp")
...
target_include_directories(spine-cocos2dx PUBLIC "${SPINE_RUNTIMES_PATH}/spine-cocos2dx/src/")
